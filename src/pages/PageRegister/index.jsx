...
import WrapperPromo from '../components/WrapperPromo';
      ...
      >
        <div className={classes.register}>
          ...
          <span className={classes.label}>
            или <Link className={classes.link} to='/login'>Войдите</Link>
          </span>
          {
            (stepRegistration === 1
              && (
                <React.Fragment>
                  ...
                  <Link className={classes.link} to='/restore'>Забыли пароль?</Link>
                </React.Fragment>
              ))
            || (stepRegistration === 2
              && (
